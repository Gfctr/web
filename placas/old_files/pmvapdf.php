...
<!DOCTYPE html>
    ...
    <body class='pdf'>
        <div align='center'>
            <img src='./files/logo.jpg' class='logo-pmav'>
            <p class='texto-pmva'>$nome<br>$embalagem</p>
            
            <div class='container'>
                <img src='./files/preco.png' class='logo-preco-pmva'>
                <p class='texto-preco-pmva'>VAREJO R$ $pVarejo<br>ATACADO R$ $pAtacado</p>
                <p class='texto-pmva-calc'>A PARTIR DE 3 X $pAtacado = R$ $npAtacado</p>
            </div>                
        </div>
        <hr class='linha'>
